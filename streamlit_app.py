...
st.info(
    "This system uses a Planner, Retriever, and Evaluator to answer patient-specific queries. "
    "The Planner and Evaluator currently use heuristics rather than an LLM (see README)."
)
